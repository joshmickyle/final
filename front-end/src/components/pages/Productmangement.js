          ...
          <form onSubmit={submitHandler}>
            <ul className="form-container">
              ...
              <li>
                {loadingSave && <Loader />}
                {errorSave && (
                  <span className="new badge red">{errorSave}</span>
                )}
              </li>
              <li>
              ...
              <li>
                <button
                  type="submit"
                  className="waves-effect waves-light btn-small manage-button"
                >
                  {_id ? "Update" : "Create"}
                </button>
                <button
          ...
          <tbody>
            {products.map((product) => (
              <tr key={product._id}>
                ...
                <td>
                  <button
                    className="waves-effect waves-light btn-small table-button"
